...
class AttackType(metaclass=ABCMeta): 
    ...
    def set_init(self, honest_chain: Chain, adver_list:list[miner.Miner], \
        ...
        self.adver_list_ids: set[int] = {miner.miner_id for miner in self.adver_list}
        self.eclipsed_list_ids: set[int] = set(eclipsed_list_ids) if eclipsed_list_ids is not None else None
