    ...
    def info_getter(self):
        ...
        with open(ATTACK_RESULT_PATH / f'Attack Log result.txt','a') as f:
                ...
                for eb in all_eclipse_blocks:
                    print(eb.name, '\n',file=f)
        return {'Adversary block': '{}'.format(adver_block_num),
                'Eclipsed by adversary block': '{}'.format(eclipse_block),
                'All blocks generated by eclipsed miner': '{}'.format(all_eclipse_block),
