...
from network import DIRECT, ERR_OUTAGE, GLOBAL, GetDataMsg, INVMsg, Network, Packet
...
class TopologyNetwork(Network):
    ...
    def stat_block_propagation_times(self, packet: TPPacket, r):
    ...
    def network_generator(self, gen_net_approach, ave_degree=None):
        ...
        try:
            ...
            for minerid in list(self._graph.nodes):
                self._miners[int(minerid)].neighbors = \
